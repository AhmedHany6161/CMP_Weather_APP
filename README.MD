...
- The current app architecture consists of three layers: UI, and data. This design was chosen because the project's business logic is relatively simple, involving only three screens and a single API call. 
